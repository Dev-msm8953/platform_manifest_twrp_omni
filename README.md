...
To get started with this custom TWRP manifest, you'll need to get
...
To initialize a shallow clone, which will save even more space, use a command like this:
    ...
    repo init --depth=1 -u git://github.com/TWRP-Mi-A2-Lite/platform_manifest_twrp_omni.git -b twrp-9.0
